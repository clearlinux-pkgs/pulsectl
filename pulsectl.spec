...
Version  : 20.2.2
Release  : 16
URL      : https://files.pythonhosted.org/packages/06/70/ec145718b1e7d0294ae568e0ad8d0a7495311ab4f69b244c1c55c10aa864/pulsectl-20.2.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/06/70/ec145718b1e7d0294ae568e0ad8d0a7495311ab4f69b244c1c55c10aa864/pulsectl-20.2.2.tar.gz
...
%prep
%setup -q -n pulsectl-20.2.2
cd %{_builddir}/pulsectl-20.2.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581050314
...
cp %{_builddir}/pulsectl-20.2.2/COPYING %{buildroot}/usr/share/package-licenses/pulsectl/cf26bfe991e3b69342541ed04634bf6a19297b70
