...
%prep
%setup -q -n pulsectl-20.2.4
cd %{_builddir}/pulsectl-20.2.4
...
cp %{_builddir}/pulsectl-20.2.4/COPYING %{buildroot}/usr/share/package-licenses/pulsectl/cf26bfe991e3b69342541ed04634bf6a19297b70
