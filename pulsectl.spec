...
Version  : 20.1.2
Release  : 15
URL      : https://files.pythonhosted.org/packages/70/4f/431ba56f200f2321e3d8f36535e747bdffef862919cf15573bd59cca9235/pulsectl-20.1.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/70/4f/431ba56f200f2321e3d8f36535e747bdffef862919cf15573bd59cca9235/pulsectl-20.1.2.tar.gz
...
%prep
%setup -q -n pulsectl-20.1.2
cd %{_builddir}/pulsectl-20.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578943885
...
cp %{_builddir}/pulsectl-20.1.2/COPYING %{buildroot}/usr/share/package-licenses/pulsectl/cf26bfe991e3b69342541ed04634bf6a19297b70
