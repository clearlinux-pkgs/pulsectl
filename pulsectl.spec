...
Version  : 20.5.0
Release  : 20
URL      : https://files.pythonhosted.org/packages/14/c1/968309d099aa67b7e23230046319a86efee6b77a39c6abfd9ebbe1b7bcb2/pulsectl-20.5.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/14/c1/968309d099aa67b7e23230046319a86efee6b77a39c6abfd9ebbe1b7bcb2/pulsectl-20.5.0.tar.gz
...
%prep
%setup -q -n pulsectl-20.5.0
cd %{_builddir}/pulsectl-20.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589986611
...
cp %{_builddir}/pulsectl-20.5.0/COPYING %{buildroot}/usr/share/package-licenses/pulsectl/cf26bfe991e3b69342541ed04634bf6a19297b70
